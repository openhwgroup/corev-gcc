...
int foo55 (int a, int b)
{
	return __builtin_riscv_cv_simd_sra_h(a, b);
}


int foo56 (int a, int b)
{
...
int foo136 (int a, int b, int c)
{
	return __builtin_riscv_cv_simd_shuffle2_h(a, b, c);
}


int foo137 (int a, int b, int c)
{
...
int foo172 (int a, int b)
{
	return __builtin_riscv_cv_simd_cmple_h(a, b);
}


int foo173 (int a, int b)
{
